...
- [Upgrading From Version 15-24 up to Version 25](#upgrading-from-version-15-24-up-to-version-25)
  ...
  - [Executing the upgrade](#executing-the-upgrade)
    ...
    - [Task 3 – Prepare the existing databases](#task-3--prepare-the-existing-databases)
...
Run the New-UpgradeInitializationScript command and use the created config.json file:
...
> Configuration loaded on C:\Upgrade_153\config.json.
> WARNING: Please open Readme.txt file in C:\Upgrade_153\License.
