...
- [Upgrading From Version 14 Customized C/AL Application to LS Central 25](#upgrading-from-version-14-customized-cal-application-to-ls-central-25)
  ...
  - [Using the preparation script](#using-the-preparation-script)
    ...
    - [Compiling the extensions that will be used in the migration](#compiling-the-extensions-that-will-be-used-in-the-migration)
      ...
      - [Renaming the tables to conform the new prefixed tables naming - Exporting the tables](#renaming-the-tables-to-conform-the-new-prefixed-tables-naming---exporting-the-tables)
      - [Renaming the tables to conform the new prefixed tables naming - Importing and compiling the tables](#renaming-the-tables-to-conform-the-new-prefixed-tables-naming---importing-and-compiling-the-tables)
      - [Renaming the tables to conform the new prefixed tables naming - Export the renamed tables](#renaming-the-tables-to-conform-the-new-prefixed-tables-naming---export-the-renamed-tables)
...
#### Renaming the tables to conform the new prefixed tables naming - Exporting the tables
...
#### Renaming the tables to conform the new prefixed tables naming - Importing and compiling the tables
...
#### Renaming the tables to conform the new prefixed tables naming - Export the renamed tables
